...
sudo scutil --set ComputerName "Luc's MBP"
sudo scutil --set HostName "Luc's MBP"
sudo scutil --set LocalHostName "Luc's MBP"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Luc's MBP"
...
# Increase all available parameters for Bluetooth headphones
